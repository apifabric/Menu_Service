...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.MenuItemPromotion, method_decorators= method_decorators)
    api.expose_object(database.models.Promotion, method_decorators= method_decorators)
    api.expose_object(database.models.MenuItemSupplier, method_decorators= method_decorators)
