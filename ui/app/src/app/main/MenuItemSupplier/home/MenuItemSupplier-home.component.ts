...
@Component({
  selector: 'MenuItemSupplier-home',
  templateUrl: './MenuItemSupplier-home.component.html',
  styleUrls: ['./MenuItemSupplier-home.component.scss']
})
export class MenuItemSupplierHomeComponent implements AfterViewInit {
