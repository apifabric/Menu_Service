...
@Component({
  selector: 'MenuItemPromotion-home',
  templateUrl: './MenuItemPromotion-home.component.html',
  styleUrls: ['./MenuItemPromotion-home.component.scss']
})
export class MenuItemPromotionHomeComponent implements AfterViewInit {
